...
**SCSTempCal** — программа для теоретической оценки максимальной температуры, достигаемой в реакциях синтеза горением из растворов (Solution Combustion Synthesis — SCS) и самораспространяющегося высокотемпературного синтеза (СВС / SHS).
...
|`fig.png`                |Изображение для стартового экрана   |
